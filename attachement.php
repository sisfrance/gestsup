...
if ($freeslot!="0" && ($globalrow['state']!=3 || ($_SESSION['profile_id']==0 || $_SESSION['profile_id']==4)))
{
	...
	echo '<input style="display:inline;" id="file'.$freeslot.'" type="file" name="file'.$freeslot.'" /> &nbsp;';
	echo '<button style="margin: 0px 0px 0px 5px; height: 22px; width:30px;" class="btn btn-minier btn-success" title="'.T_('Enregistrer le ticket et charger le fichier').'" name="upload" value="upload" type="submit" id="upload"><i class="icon-upload bigger-150"></i></button>';
...
if ($row['img1']!='')
{
	echo "<br /><a target=\"_blank\" title=\"$row[img1]\" href=\"./upload/$_GET[id]/$row[img1]\" style=\"text-decoration:none\"><i style=\"vertical-align: middle;\" class=\"icon-file blue bigger-200\" ></i>&nbsp;</a>&nbsp;<a target=\"_blank\" title=\"$row[img1]\" href=\"./upload/$_GET[id]/$row[img1]\" >$row[img1]</a>" ;
...
if ($row['img2']!='')
{
	echo "<br /><a target=\"_blank\" href=\"./upload/$_GET[id]/$row[img2]\" title=\"$row[img2]\" style=\"text-decoration:none\"><i style=\"vertical-align: middle;\" class=\"icon-file blue bigger-200\" ></i>&nbsp;</a>&nbsp;<a target=\"_blank\" href=\"./upload/$_GET[id]/$row[img2]\" title=\"$row[img2]\">$row[img2]</a>";
...
if ($row['img3']!='')
{
	echo "<br /><a target=\"_blank\" href=\"./upload/$_GET[id]/$row[img3]\" title=\"$row[img3]\" style=\"text-decoration:none\"><i style=\"vertical-align: middle;\" class=\"icon-file blue bigger-200\" ></i>&nbsp;</a>&nbsp;<a target=\"_blank\" href=\"./upload/$_GET[id]/$row[img3]\" title=\"$row[img3]\" >$row[img3]</a>";
...
if ($row['img4']!='')
{
	echo "<br /><a target=\"_blank\" href=\"./upload/$_GET[id]/$row[img4]\" title=\"$row[img4]\" style=\"text-decoration:none\"><i style=\"vertical-align: middle;\" class=\"icon-file blue bigger-200\" ></i>&nbsp;</a>&nbsp;<a target=\"_blank\" href=\"./upload/$_GET[id]/$row[img4]\" title=\"$row[img4]\" >$row[img4]</a>";
...
if ($row['img5']!='')
{
	echo "<br /><a target=\"_blank\" href=\"./upload/$_GET[id]/$row[img5]\" title=\"$row[img5]\" style=\"text-decoration:none\"><i style=\"vertical-align: middle;\" class=\"icon-file blue bigger-200\" ></i>&nbsp;</a>&nbsp;<a target=\"_blank\" href=\"./upload/$_GET[id]/$row[img5]\" title=\"$row[img5]\" >$row[img5]</a>";
