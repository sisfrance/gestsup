...
<div class="tabbable tabs-left">
	...
	<div class="tab-content">
		...
		if(($_GET['table']=='tstates' || $_GET['table']=='tassets_state')&& ($_GET['action']=='disp_edit' || $_GET['action']=='disp_add'))
		{
			...
			echo '<span class="label label-sm label-yellow arrowed arrowed-right arrowed-left">label label-sm label-yellow arrowed arrowed-right arrowed-left</span><br />';
			echo '<span class="label label-sm label-info arrowed-in">label label-sm label-info arrowed-in</span><br />';
			echo '<span class="label label-sm label-primary arrowed arrowed-right arrowed-left">label label-sm label-primary arrowed arrowed-right arrowed-left</span><br />';
			echo '<span class="label label-sm label-purple arrowed arrowed-right arrowed-left">label label-sm label-purple arrowed arrowed-right arrowed-left</span><br />';
			...
			echo '<span class="label label-sm label-default arrowed arrowed-right arrowed-left">label label-sm label-default arrowed arrowed-right arrowed-left</span><br />';
			echo '<span class="label label-sm label-grey arrowed arrowed-right arrowed-left">label label-sm label-grey arrowed arrowed-right arrowed-left</span><br />';
			echo '<span class="label label-sm label-light arrowed arrowed-right arrowed-left">label label-sm label-light arrowed arrowed-right arrowed-left</span><br />';
