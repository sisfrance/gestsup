							...
							<div class="profile-info-value">
								<span id="username">
									...
									<blockquote>
										...
										<br />
										<label>
											<input class="ace" type="checkbox" <?php if ($rparameters['mail_auto_tech_attribution']==1) echo "checked"; ?> name="mail_auto_tech_attribution" value="1" />
											<span class="lbl">&nbsp;<?php echo T_("Au technicien lors de l'attribution d'un ticket à un technicien"); ?></span>
										</label>
										<br />
										<label>
									...
									<div class="space-4"></div>
									<label for="mail_template"><?php echo T_("Modèle de mail"); ?> :</label>
									<select class="textfield" id="mail_template" name="mail_template" >
										<?php
