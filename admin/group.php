							...
							<form id="1" name="form" method="post"  action="">
								...
								<label for="name">'.T_('Membres actuels').' :</label><br />';
									...
									while ($ruser=$qry->fetch()) 
									{
										...
										<a title="'.T_('Enlever l\'utilisateur du groupe').'" onClick="javascript: return confirm(\''.T_('Êtes-vous sur de vouloir supprimer cet utilisateur ?').'\');" href="./index.php?page=admin&amp;subpage=group&amp;id='.$_GET['id'].'&amp;user='.$ruser[2].'&amp;action=delete"><i class="icon-trash red bigger-120"></i></a><br />';
									}
									$qry->closeCursor(); 
									echo '
								</fieldset>
						...
						<tbody>';
							...
							while ($rgroup=$qry->fetch()) 
							{
								...
								<tr>
									...
									echo '
									<td>
										<a style="margin: 0px 0px 0px 0px; height:25px; width:30px;" class="btn btn-minier btn-warning" href="./index.php?page=admin&amp;subpage=group&amp;action=edit&amp;id='.$rgroup['id'].'"  title="'.T_('Modifier ce groupe').'" ><center><i class="icon-pencil white bigger-160"></i></center></a>
										<a style="margin: 0px 0px 0px 5px; height: 25px; width:30px;" class="btn btn-minier btn-danger" onClick="javascript: return confirm(\''.T_('Êtes-vous sur de vouloir supprimer ce groupe ?').'\');" href="./index.php?page=admin&amp;subpage=group&amp;id='.$rgroup['id'].'&amp;type='.$_GET['type'].'&amp;action=delete"  title="'.T_('Supprimer ce groupe').'" ><center><i class="icon-trash white bigger-160"></i></center></a>
									</td>
								</tr>';
							}
							echo '
